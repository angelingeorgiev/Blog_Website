...
# Create the BlogP Table (Child), BlogP Table (Parent) to Comment (Child)
class BlogPost(db.Model):
    ...
    comments = relationship("Comment", back_populates="p_post")


# Create a BlogP Comment DB (Child)
class Comment(db.Model):
    ...
    author_id = db.Column(db.Integer, db.ForeignKey("users.id"))
    p_post = relationship("BlogPost", back_populates="comments")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Find user via email entered previously
